...
class WatchSocketDataSource {
  ...
  final _chatThrottled = StreamController<void>.broadcast();
  ...
  Stream<void> get chatThrottled => _chatThrottled.stream;
  ...
  void _bind() {
    ...
    _subs.addAll([
      ...
      _socket.on('chat_throttled').listen((_) => _add(_chatThrottled, null)),
  ...
  void sendChat(String text) => _socket.emitEvent('chat', {'text': text});
